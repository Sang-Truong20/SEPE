...
export const teamJoinRequestQueryKeys = {
  ...
  detail: (requestId) => [
    ...teamJoinRequestQueryKeys.origin,
    'detail',
    requestId,
  ],
...
export const useCreateTeamJoinRequest = (options = {}) => {
  ...
  return useMutation({
    ...
    mutationFn: async ({ teamId, message }) => {
      const response = await axiosClient.post('/TeamJoinRequest', {
        teamId,
        message,
      });
...
export const useGetTeamJoinRequestsToMyTeams = (options = {}) => {
  return useQuery({
    queryKey: [...teamJoinRequestQueryKeys.origin, 'to-my-teams'],
    queryFn: async () => {
      const response = await axiosClient.get('/TeamJoinRequest/my-requests');
  ...
  return useMutation({
    ...
    mutationFn: async ({ requestId, status, leaderResponse }) => {
      const response = await axiosClient.put(
        `/TeamJoinRequest/${requestId}/respond`,
        {
          status,
          leaderResponse,
        },
