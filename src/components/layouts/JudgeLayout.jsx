...
const JudgeLayout = () => {
  ...
  const selectedKey = location.pathname.startsWith(PATH_NAME.JUDGE_TEAM_SCORES)
    ? PATH_NAME.JUDGE_TEAM_SCORES
    : '';
      ...
      >
        ...
        <div className="demo-logo-vertical p-4">
          <div className="flex items-center space-x-3">
            ...
            {!collapsed && (
              <div>
                <div className="text-white font-semibold">Judge Panel</div>
                <div className="text-gray-400 text-sm">Ban giám khảo</div>
              </div>
            )}
          </div>
        </div>
