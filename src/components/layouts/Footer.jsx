...
import fptLogo from '../../assets/images/logo/fpt-logo.webp';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-lg font-semibold bg-gradient-to-r from-orange-400 to-blue-400 bg-clip-text text-transparent">
                SEAL Hackathon
              </span>
            </div>
            <p className="text-sm leading-relaxed text-gray-400">
              Nền tảng hackathon chính thức của Đại học FPT — nơi sinh viên IT
              thể hiện tài năng, đam mê và sáng tạo công nghệ.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {['Duyệt Hackathons', 'Tạo Nhóm', 'Nộp Dự án', 'Xem Kết quả'].map(
                (item, idx) => (
                  <li key={idx}>
                    <a
                      href="#"
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {['Tài liệu', 'API Reference', 'Cộng đồng', 'Hỗ trợ'].map(
                (item, idx) => (
                  <li key={idx}>
                    <a
                      href="#"
