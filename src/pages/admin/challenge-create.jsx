import { HomeOutlined, InboxOutlined, InfoCircleOutlined } from '@ant-design/icons';
import { Breadcrumb, Button, Divider, Form, Input, Upload, message } from 'antd';
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-600 mt-1">Fill in the details to create a new challenge</p>
      </div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-6">
                <Form.Item
                  label={<span className="text-sm font-medium text-gray-700">Challenge Title</span>}
                  name="Title"
                  rules={[{ required: true, message: 'Please enter a challenge title' }]}
                  className="mb-0"
                >
                  <Input
                    size="large"
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Form.Item
                  label={<span className="text-sm font-medium text-gray-700">Season ID</span>}
                  name="SeasonId"
                ...
                <Form.Item
                  label={<span className="text-sm font-medium text-gray-700">File Path</span>}
                  name="FilePath"
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-2 mb-6">
                <div className="w-1 h-6 bg-green-500 rounded-full"></div>
                <h3 className="text-lg font-semibold text-gray-800">Challenge Resources</h3>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6 mb-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-green-800 mb-1">File Upload Guidelines</h4>
                    <ul className="text-sm text-green-700 space-y-1">
                      <li>• Supported formats: ZIP, PDF, DOC, TXT, JSON, XML</li>
                      <li>• Maximum file size: 10MB</li>
                      <li>• Include all necessary challenge materials and documentation</li>
              ...
              <Form.Item
                label={<span className="text-sm font-medium text-gray-700">Challenge File</span>}
                name="file"
                valuePropName="fileList"
                getValueFromEvent={normFile}
                rules={[{ required: true, message: 'Please select a challenge file' }]}
                className="mb-0"
                tooltip="Upload the main challenge file (code, documentation, assets, etc.)"
              >
                <Upload.Dragger {...uploadProps} className="custom-upload-dragger">
                  <p className="ant-upload-drag-icon">
                    <InboxOutlined style={{ color: '#10b981', fontSize: '48px' }} />
                  </p>
                  <p className="ant-upload-text" style={{ color: '#374151', fontSize: '16px', fontWeight: '600', marginBottom: '8px' }}>
                    Click or drag file to this area to upload
                  </p>
                  <p className="ant-upload-hint" style={{ color: '#6b7280', fontSize: '14px' }}>
                    Support for single file upload. Accepted formats: ZIP, PDF, DOC, TXT, JSON, XML. 
